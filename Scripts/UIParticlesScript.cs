...
public class UIParticlesScript : MaskableGraphic {
    ...
    protected bool Initialize () {
        ...
        if (_particleSystem == null) {
            ...
            ParticleSystemRenderer trenderer = _particleSystem.GetComponent<ParticleSystemRenderer> ();
            if (trenderer == null) {
                trenderer = _particleSystem.gameObject.AddComponent<ParticleSystemRenderer> ();
            }
            Material currentMaterial = trenderer.sharedMaterial;
            ...
            /*   Material material = new Material(Shader.Find("UI/Particles/Hidden")); // TODO - You should create this discard shader
               if (Application.isPlaying)
               {
                ...
                trenderer.sharedMaterial = material;
            }
#endif
